            ...
            child: Column(
              ...
              children: [
                ...
                TextWidget(
                    title: 'Date',
                    date:
                        "${DateFormat.y().format(now)}:${DateFormat.M().format(now)}:${DateFormat.d().format(now)}"),
                TextWidget(
                    title: 'Date',
                    date:
                        "${DateFormat.y().format(now)}-${DateFormat.M().format(now)}-${DateFormat.d().format(now)}"),
                ...
                TextWidget(
                    title: 'Date DMY',
                    date:
                        "${DateFormat.d().format(now)}/${DateFormat.M().format(now)}/${DateFormat.y().format(now)}"),
                const Divider(),
                TextWidget(
                    title: 'Date', date: DateFormat.d().format(DateTime.now())),
                TextWidget(
                    title: 'Day name',
                ...
                const Divider(),
                TextWidget(
                    title: 'Year', date: DateFormat.y().format(DateTime.now())),
                const Divider(),
                TextWidget(
                    title: 'Hour', date: DateFormat.H().format(DateTime.now())),
                TextWidget(
                ...
                TextWidget(
                    title: 'Time in AM',
                    date: DateFormat.jm()
                        .format(DateTime.now().copyWith(hour: 10))),
                TextWidget(
                    title: 'Time in PM',
                ...
                TextWidget(
                    title: 'Today date',
                    date: DatesUtils().compareTimesForSevenDays(
